...
const optionalNumber = z.union([z.coerce.number().min(0), z.null()]).optional();
...
export const updateMotorcycleProfileSchema = z.object({
  body: z.object({
    ...
    ano: z.union([z.coerce.number().int().min(1900).max(2100), z.null()]).optional(),
